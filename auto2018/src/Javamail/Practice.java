package Javamail;
	...
	public class Practice {
		...
		public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
			...
			// 2. From: 发件人
			message.setFrom(new InternetAddress(sendMail, "我的测试邮件", "UTF-8"));

			// 3. To: 收件人（可以增加多个收件人、抄送、密送）
			message.addRecipient(RecipientType.TO, new InternetAddress(receiveMail, "我的测试邮件", "UTF-8"));
			...
			DataHandler dh = new DataHandler(new FileDataSource("F:\\git\\test-practice\\auto2018\\material\\1120.png")); // 读取本地文件
			...
			text.setContent("这是一张图片<br/><img src='cid:image_page_one'/>", "text/html;charset=UTF-8");
...
//			text.setContent("这是一张图片","text/html;charset=UTF-8");
			...
			DataHandler dh2 = new DataHandler(new FileDataSource("F:\\git\\test-practice\\auto2018\\material\\1.xlsx")); // 读取本地文件
